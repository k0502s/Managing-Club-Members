...
const AddMemberPage = () => {
    ...
    const { isLoading2 } = useSelector((state: State) => state.member);
                    ...
                    <S.AddCard>
                        ...
                        <CardBody>
                            ...
                            <Form onSubmit={submitHandler} name="myform" data-testid="form">
                                ...
                                <br />
                                <select onChange={onChangeSex} value={Sex.sex} name="sex" data-testid="add-sex">
