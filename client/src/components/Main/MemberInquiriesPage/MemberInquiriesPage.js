                    ...
                    <Table>
                        ...
                        {inquiriesdata &&
                            inquiriesdata.map((inquiries, index) => (
                                <tbody key={index}>
                                    <tr>
                                        <th style={{ width: '10%', fontWeight: 'bold', textAlign: 'center' }} data-testid="inquiries-name">
                                            {inquiries.name}
                                        </th>
                                        <td style={{ width: '15%', color: 'black', fontWeight: 'bold', fontSize: 'large', textAlign: 'center' }} data-testid="inquiries-email">
                                            {inquiries.email}
                                        </td>
                                        <td style={{ width: '25%' }} data-testid="inquiries-opinion">
                                            {inquiries.opinion}
                                        </td>
                                        <td style={{ width: '10%', textAlign: 'center' }}>
                                            <Button onClick={() => removeFromInquiries(inquiries._id)} data-testid="inquiries-button">
                                                삭제
                                            </Button>
                                        </td>
                                    </tr>
