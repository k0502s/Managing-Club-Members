...
* 처음에는 그냥 하지말까 생각도 하였지만 이 구현하고 싶은 기능들을 흉내라도 내보고 싶은 마음에 깃허브나 검색을 통해 기능을 구현할 수 있는 코드들을 참고하여 이 프로젝트에 기능 구현을 해결하였습니다. 이런한 해결을 통해 다른 사람의 코드를 분석하고 나만의 원하는 코드로 커스텀마이징 하여 다시 적용시키는 과정이 엄청 힘든 과정인 것을 깨달았고 앞으로 이런 일을 해결하고 적용하는 것 또한 개발자의 중요한 역량이라는 것 또한 깨닫게 되었습니다.

* TypeScript을 적용하는 것 또한 어려움을 느꼈던 것 같았습니다. 처음 배워 처음 적용해보는 프로젝트인 것도 있었지만 자바스크립트에 없는 타입 지정에 익숙하지 못한 탓도 있었던 것 같았습니다. 하지만 한 번
